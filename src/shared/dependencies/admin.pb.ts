...
/** Analytics Messages */
export interface TotalOrganizationsData {
  count: number;
  trendData: TrendData[];
}
...
export interface TopPerformingOrganizationsData {
...
export interface DailyActiveUsersAnalytics {
...
export interface ActiveUsersCountData {
  count: number;
  percentage: number;
  trend: string;
  trendData: TrendData[];
...
export interface OverviewAnalyticsResponse {
  totalOrganizations: TotalOrganizationsData | undefined;
  topPerformingOrganizations: TopPerformingOrganizationsData | undefined;
  dailyActiveUsers: DailyActiveUsersAnalytics | undefined;
  activeUsersCount: ActiveUsersCountData | undefined;
}
...
export interface AdminServiceClient {
  ...
  overviewAnalytics(request: EmptyRequest): Observable<OverviewAnalyticsResponse>;
}
...
export interface AdminServiceController {
  ...
  ): Promise<OverviewAnalyticsResponse> | Observable<OverviewAnalyticsResponse> | OverviewAnalyticsResponse;
}
