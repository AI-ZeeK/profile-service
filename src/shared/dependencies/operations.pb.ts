...
export interface BusinessTypeIdRequest {
...
export interface GetBusinessTypeResponse {
  success: boolean;
  error?: string | undefined;
  businessType: BusinessTypeData | undefined;
}
...
export interface OperationServiceClient {
  ...
  getBusinessType(request: BusinessTypeIdRequest): Observable<GetBusinessTypeResponse>;
  ...
  updateAdminBusinessType(request: UpdateBusinessTypeRequest): Observable<UtilitiesResponse>;
...
export interface OperationServiceController {
  ...
  getBusinessType(
    request: BusinessTypeIdRequest,
  ): Promise<GetBusinessTypeResponse> | Observable<GetBusinessTypeResponse> | GetBusinessTypeResponse;
